...
#include "CancerControllerComponent.generated.h"


UCLASS(ClassGroup=(Cancer), Blueprintable, BlueprintType, meta=(BlueprintSpawnableComponent))
class CANCERGAMEPLAY_API UCancerControllerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UCancerControllerComponent(const FObjectInitializer& ObjectInitializer);
	...
	T* GetPlayer() const
	{
		static_assert(TPointerIsConvertibleFromTo<T, UPlayer>::Value,
