...
#include "CancerPawnComponent.generated.h"


UCLASS(ClassGroup=(Cancer), Blueprintable, BlueprintType,  meta=(BlueprintSpawnableComponent))
class CANCERGAMEPLAY_API UCancerPawnComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UCancerPawnComponent(const FObjectInitializer& ObjectInitializer);
