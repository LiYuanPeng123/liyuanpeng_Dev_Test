...
#include "CancerPenetrationAvoidanceFeeler.generated.h"

/**
定义了一种用于避免相机穿透的试探射线的结构。
 */
USTRUCT(NotBlueprintType,Blueprintable)
struct FCancerPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FCancerPenetrationAvoidanceFeeler()
	...
	FCancerPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
