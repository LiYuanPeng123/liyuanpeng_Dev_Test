...
#include "CancerContextEffectsInterface.h"

#include "CancerContextEffectComponent.generated.h"
...
class UCancerContextEffectComponent : public UActorComponent, public ICancerContextEffectsInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UE_API UCancerContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<UCancerContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	UE_API void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	UE_API void UpdateLibraries(TSet<TSoftObjectPtr<UCancerContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<UCancerContextEffectsLibrary>> CurrentContextEffectsLibraries;
