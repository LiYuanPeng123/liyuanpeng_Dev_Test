...
#include "AnimNotify_CancerContextEffects.generated.h"
...
struct FCancerContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FCancerContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FCancerContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FCancerContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/CancerGame.CancerContextEffectsLibrary"))
...
class UAnimNotify_CancerContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UE_API UAnimNotify_CancerContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FCancerContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FCancerContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FCancerContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FCancerContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
