...
private:
	...
	// Get the image to show for the toggle show node moves option
	FSlateIcon GetShowNodeMovesImage() const;
	...
	// User toggles the option to show/hide node moves
	void OnToggleShowNodeMoves();
	...
	// If node move differences should be shown
	bool bShowNodeMoves = true;
