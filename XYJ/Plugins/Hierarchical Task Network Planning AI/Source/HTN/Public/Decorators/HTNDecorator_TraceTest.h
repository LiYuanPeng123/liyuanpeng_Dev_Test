...
public:
	...
	UPROPERTY(EditAnywhere, Category = Trace, Meta = (DisplayName = "Trace From"))
	FHTNLocationSource TraceFromSource;

	UPROPERTY(EditAnywhere, Category = Trace, Meta = (DisplayName = "Trace To"))
	FHTNLocationSource TraceToSource;

	UPROPERTY()
	FBlackboardKeySelector TraceFrom_DEPRECATED;

	UPROPERTY()
	float TraceFromZOffset_DEPRECATED;

	UPROPERTY()
	FBlackboardKeySelector TraceTo_DEPRECATED;

	UPROPERTY()
	float TraceToZOffset_DEPRECATED;
